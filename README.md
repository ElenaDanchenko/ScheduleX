...
### 1. Функция «Добавить нового сотрудника»
...
## Функции системы (продолжение)

### 3. Функция «Просмотр расписания»
...
### 4. Функция «Автоматическая генерация расписания»
