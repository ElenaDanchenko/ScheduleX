...
## Некоторые профили пользователей
...
Границы системы и взаимодействия с внешними сущностями наглядно отображены на [диаграмме потоков данных](#диаграмме-потоков-данных) (DFD).
