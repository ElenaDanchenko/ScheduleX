...
Анализ причин проблем с использованием диаграммы Ишикавы позволил выявить ключевые бизнес-правила и требования к системе управления расписанием.  Основываясь на этих правилах, был выполнен [процесс моделирования бизнес-процессов](#моделирование-бизнес-процессов) в нотации BPMN.
